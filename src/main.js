...
import "@/mobile/flexible.js" //适配 .js可以省略
import "@/styles/reset.css" //初始化样式
import router from "@/router" //路由对象

import { Tabbar, TabbarItem, NavBar, Col, Row, Image as VanImage, Cell, Icon, Search, List, Swipe, SwipeItem } from 'vant';
...
//1.下载postcss postcss-pxtorem@5.1.1（注意要和当前脚手架webpack兼容）
//2.postcss.config.js - 填入插件转换的基准值（配置可以复制md也可以百度）
//3.一定要重启服务器，观察效果
